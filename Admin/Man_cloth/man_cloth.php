            ...
            <div class="row" style="margin-top:200px; margin-left: 200px">
                ...
                <div class="col-12">
                    <fieldset class="container">
                        ...
                        <legend class="col-form-label  pt-0">Mans_clothes</legend>
                        ...
                        <div class="row">
                            <div class="col-sm-10 form-control">
                                ...
                                <div class="custom-file">
                                    ...
                                    <input type="file" name="man_img" class="custom-file-input" id="fileInput" accept="image/jpeg, image/png, application/pdf" onchange="previewFile(event)" required>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                ...
                <script src='./man_cloth_pic_display.js'></script>
                <!--**************************************************************-->
