    ...
    <div class="container-fluid">
        ...
        <form class="container" id="registrationForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="row" style="margin-top:200px; margin-left: 200px">
                        ...
                        <div class="row">
                            <div class="col-sm-10 form-control">
                                ...
                                <div class="custom-file">
                                    ...
                                    <input type="file" name="womans_img" class="custom-file-input" id="fileInput" accept="image/jpeg, image/png, application/pdf" onchange="previewFile(event)" required>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                ...
                <script src='./womans_choose_pic_display.js'></script>
                <!--**************************************************************-->
