...
<body class="body1">
    ...
    <div class="container-fluid " style="margin-left:250px">
        ...
        <form class=" my-5 g-3 container font-weight-bold " id="registrationForm" method="POST" enctype="multipart/form-data" style="margin: auto; width: 750px;">
            ...
            <h1 class="my-3" style="margin: auto; width: 750px; text-align: center; ">Computer & Laptop</h1>
            ...
            <div class="row my-2">
                    ...
                    <fieldset class=" container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 form-control">
                                <label class="custom-file-label" for="fileInput">Choose File : [ Under 10mb ] JPG, PNG, & PDF Format Only</label>
                ...
                <script src="./computer_file_upload_comdition_check.js"></script>
                <!--************************************************************* -->


                <!-- # file image & pdf show ( display ) javascript -->
                <script src='./computer_pic_display_code.js'></script>
                <!--**************************************************************-->
