...
<body class="body1">
    ...
    <nav class="sidebar locked">
        ...
        <div class="menu_container">
            ...
            <div class="sidebar_profile flex">
                <span class="nav_image">
                    <img src="./img_logo/goutham-krishna-h5wvMCdOV3w-unsplash.jpg" alt="logo_img" />
                </span>
                <div class="data_text">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12">
                <form class=" my-5 g-3 container font-weight-bold " action="./insert_mobile.php" id="registrationForm" method="POST" enctype="multipart/form-data" style="margin: auto; width: 750px;">
